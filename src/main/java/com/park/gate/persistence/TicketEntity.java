...
public class TicketEntity {
    ...
    public boolean canAccessGate(GateType gateType) {
        if (type == TicketType.VIP_TICKET) return true;
    ...
    public TicketAgeCategory getAgeCategory() { return ageCategory; }
    public void setAgeCategory(TicketAgeCategory ageCategory) { this.ageCategory = ageCategory; }
    ...
    public String getUsedAtGate() { return usedAtGate; }
    public void setUsedAtGate(String usedAtGate) { this.usedAtGate = usedAtGate; }
